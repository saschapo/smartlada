...
// (OUT0..3), pluggable animation effects. Rev C pin remap only (channels {1,0,2,3},
// buttons {23,22,21,20}); PD power-good/VBUS-sense gating is NOT yet implemented.
// Build with USB CDC for Serial on native USB:
